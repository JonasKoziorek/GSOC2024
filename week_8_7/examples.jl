...
#%%
a = 0.15; b=0.2; c=3.5
igs = [InitialGuess(SVector(2.0, 5.0, 10.0), 10.2), InitialGuess(SVector(2.0, 5.0, 10.0), 11.2), InitialGuess(SVector(2.0, 5.0, 10.0), 12.2)]
alg = OptimizedShooting(Δt=1/(2^6), p=3)
ds = CoupledODEs(lorenz_rule, [1.0, -2.0, 0.1], [a, b, c]; diffeq = (alg=RKO65(), abstol = 1e-14, reltol = 1e-14, dt=alg.Δt))
